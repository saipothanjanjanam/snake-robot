/* Snake Robot Lateral Undulation gait
 
 Snake performs Lateral Undulation motion with this piece of code. We can change 
...
void loop() {
  ...
  // Code for LATERAL UNDULATION
  
  
  Dxl.writeWord(ID_NUM1, GOAL_POSITION, 370+60*sin((1*(3.14*t)/6)+((2*3.14))/3));
  Dxl.writeWord(ID_NUM2, GOAL_POSITION, 350);
  Dxl.writeWord(ID_NUM3, GOAL_POSITION, 358+60*sin((1*(3.14*t)/6)+((4*3.14))/3));
  Dxl.writeWord(ID_NUM4, GOAL_POSITION, 357);
  Dxl.writeWord(ID_NUM5, GOAL_POSITION, 370+60*sin((1*(3.14*t)/6)+((6*3.14))/3));
  Dxl.writeWord(ID_NUM6, GOAL_POSITION, 360);
  Dxl.writeWord(ID_NUM7, GOAL_POSITION, 360+60*sin((1*(3.14*t)/6)+((8*3.14))/3));
  delay(50);
