/* Snake Robot Rolling gait
 
 Snake performs Rolling motion with this piece of code. We can change 
...
void loop() {  
  // Rolling gait                
  Dxl.writeWord(ID_NUM1, GOAL_POSITION, 366+70*sin(1*(3.14/80) + (2*3.14*t)/6));
  Dxl.writeWord(ID_NUM2, GOAL_POSITION, 350+70*sin(2*(3.14/80) + (2*3.14*t)/6 + 3.14/2));
  Dxl.writeWord(ID_NUM3, GOAL_POSITION, 358+70*sin(3*(3.14/80) + (2*3.14*t)/6));
  Dxl.writeWord(ID_NUM4, GOAL_POSITION, 357+70*sin(4*(3.14/80) + (2*3.14*t)/6 + 3.14/2));
  Dxl.writeWord(ID_NUM5, GOAL_POSITION, 370+70*sin(5*(3.14/80) + (2*3.14*t)/6));
  Dxl.writeWord(ID_NUM6, GOAL_POSITION, 360+70*sin(6*(3.14/80) + (2*3.14*t)/6 + 3.14/2));
  Dxl.writeWord(ID_NUM7, GOAL_POSITION, 360+70*sin(7*(3.14/80) + (2*3.14*t)/6));
  delay(150);
  t = t + 0.5;
}
