/* Snake Robot Sidewinding gait
 
 Snake performs Sidewinding motion with this piece of code. We can change 
...
**** OpenCM 485 EXP board is needed to use 4 pin Dynamixel and Pro Series **** 
 ...
 created 16 Nov 2012
 by Sai pothan, Piyush, Rupali  at IVLABS, VNIT Nagpur.
 */
...
void setup() {
  ...
  Dxl.writeWord(ID_NUM1, GOAL_POSITION, 366);  // For straight line formation
  ...
  Dxl.writeWord(ID_NUM7, GOAL_POSITION, 351);
  delay(150);
...
void loop() {
  ...
  // Sidewinding gait
  Dxl.writeWord(ID_NUM1, GOAL_POSITION, 370+80*sin((1*(3.14*t)/6)+((8*3.14))/3));
  Dxl.writeWord(ID_NUM2, GOAL_POSITION, 350+80*sin((1*(3.14*t)/6)+((6*3.14))/3));
  Dxl.writeWord(ID_NUM3, GOAL_POSITION, 358+80*sin((1*(3.14*t)/6)+((6*3.14))/3));
  Dxl.writeWord(ID_NUM4, GOAL_POSITION, 357+80*sin((1*(3.14*t)/6)+((4*3.14))/3));
  Dxl.writeWord(ID_NUM5, GOAL_POSITION, 370+80*sin((1*(3.14*t)/6)+((4*3.14))/3));
  Dxl.writeWord(ID_NUM6, GOAL_POSITION, 360+80*sin((1*(3.14*t)/6)+((2*3.14))/3));
  Dxl.writeWord(ID_NUM7, GOAL_POSITION, 360+80*sin((1*(3.14*t)/6)+((2*3.14))/3));
  delay(58);
}
